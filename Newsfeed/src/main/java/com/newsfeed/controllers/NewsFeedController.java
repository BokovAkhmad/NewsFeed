...
/**
 * Created by Akhmat on 26.03.2016.
 */
@Controller
public class NewsFeedController {
    ...
    public String added(ModelMap model, @ModelAttribute News news, @RequestParam("category") String category,@RequestParam("text") String text) {
        text = text.replace("\n  ","<br/>&nbsp;&nbsp;&nbsp;&nbsp;").replace("\n","<br/>");
